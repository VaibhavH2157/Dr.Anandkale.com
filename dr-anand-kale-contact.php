...
.footer_social ul li a i:hover
{
	color: #FFFFFF;
     ...
     <!--  ************************* Page Title Starts Here ************************** -->
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15009.897227738089!2d75.3593223!3d19.8621842!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdba31f723af4dd%3A0x37d2332832a15595!2sDr.%20Anand%20kale%20-%20Psychiatrist%20in%20aurangabad!5e0!3m2!1sen!2sin!4v1680188760116!5m2!1sen!2sin"  style="border:0; width: 100%; height: 60vh;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                    </iframe>
	...
	<div class="container">
		<div class="row">
				...
				<div class="col-lg-6">
					...
					<!-- <div class="contact_text my-5 text-dark">
						<h4>Dr. Anand Kales Diabetes and Psychiatry Clinic.</h4>
					</div> -->
					<ul class="contact_about_list" style="margin-bottom: 5;">
                    <?php 
								...
								<li><b><div class="footer_about_icon ">
									<img src="images/phone-call.svg"  alt=""></div><span><a href="tel:<?=$mobile?>"><?=$mobile?></a></span></b></li><br><br>
								<li><b>
									<div class="footer_about_icon"><img src="images/envelope.svg" alt=""></div>
									<span> <a href="mailto:<?=$email ?>"><?=$email ?></a></span></b></li><br><br>
								<li><b><div class="footer_about_icon"><img src="images/placeholder.svg" alt=""></div><span><a href="https://goo.gl/maps/M4rEsdtRBgRE49Cz5"> <?=$class_master_row['address1']?></a></span></b></li>
							<?php
								}
							?>
							</ul>
				...
				<?php include('messeage.php')?>
                    <form action="post-contact.php" method="post" role="form" class="php-email-form">
                        <div class="row php-email-form">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="tel" class="form-control valid" name="mobile" id="mobile"  pattern="[0-9]{10}"
                                    onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'Enter Contact Number'" placeholder="Enter Contact Number"  required   maxlength="10">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <div class="col-12">
                              ...
                              <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" name="text" id="text" cols="10" rows="8"
                            ...
                            <div class="d-flex justify-content-center ">
                                <div class="form-group mt-5 mb-5">
                                    <button class="btn button btn-lg" style="width:100%;height:100%;" type="submit">send</button>
                                </div>
                            </div>
                        </div>
                        </form>
