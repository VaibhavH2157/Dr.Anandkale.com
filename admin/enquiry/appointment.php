            ...
            <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td class="text-left text-info">Text</td>
...
//Edit form action statrs from here
    ...
    <?php        
                ...
                if(isset($_POST['edit']))
                {
                 ...
                 extract($post);
                  ...
                  $sql  = "update `appointment` set `name`=\"$fname\",`email`=\"$email\",`mobile`=\"$mobile\",`city`=\"$city\",`enquiry_for`=\"$enquiry_for\"
                 where id=$id";
   ...
   <div class="form-group">
     <label class="control-label col-sm-2" for="	photo">appointment For:</label>
      ...
      <div class="col-sm-10">
         <input type="text" class="form-control" name="enquiry_for" id="" value="<?=$enquiry_for?>" placeholder="enquiry for">
      </div>
