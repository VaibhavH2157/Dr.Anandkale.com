...
<div id="content">
  <div class="container-fluid"><br />
    ...
    margin-bottom: 10px !important" /> -->
    <!-- <h1 class=" logo me-auto  d-inline-block justify-content-center text-center d-flex"><a href="index.php" class="bg-dark mt-5" ><img src="images\kale_logo.jpg" alt=""></a></h1> -->
    <div class="row">
