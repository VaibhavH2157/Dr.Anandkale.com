      ...
      <div class="page-header">
        <div class="container-fluid">
          <div class="pull-right">
            ...
            <a href="<?php echo $base_path; ?>admin/menus/add-menu" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
          </div>
          <h1>Menus</h1>
          <ul class="breadcrumb">
          ...
          <div class="panel-body">
            ...
            ?>
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group" id="parent" <?php if ($menu_level == 1 || $menu_level == 3) {
                ...
                <div class="form-group" id="child" <?php if ($menu_level == 1 || $menu_level == 2) {
                                                      echo 'style="display: none"';
                                                    } ?>>
                  <label class="control-label col-sm-2">Choose Parent Menu</label>
                  <div class="col-sm-10">
