                    ...
                    <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                       {
...

                          {
                             ...
                             $sql  = "INSERT INTO `news_gallery` (`id`, `gallery_image`, `image_caption`, `description`, `category`, `date_added`,`height`,`width`)

                             VALUES (NULL, \"$gallery_image\", \"$image_caption\", \"$description\", \"$category\", CURRENT_TIMESTAMP, \"$height\",\"$width\")";
