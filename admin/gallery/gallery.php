              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                    {
                       ...
                       $sql  = "update `gallery` set image_caption=\"$image_caption\", description=\"$description\", category=\"$category\" , department=\"$department\" , height=\"$height\", width=\"$width\" where id=$id";
