            ...
            <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td class="text-left text-info">Department</td>
...
//Edit form action statrs from here
    ...
    <?php        
                ...
                if(isset($_POST['edit']))
                {
                 ...
                 extract($post);
                  ...
                  $sql  = "update `appointment` set `name`=\"$name\",`email`=\"$email\",`mobile`=\"$mobile\",`department`=\"$department\",
                 where id=$id";
   ...
   <div class="form-group">
     <label class="control-label col-sm-2" for="	photo">Department</label>
     <div class="col-sm-10"> 
